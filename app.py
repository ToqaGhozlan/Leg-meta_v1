...
SAVE_MESSAGES = [
    ...
    "يا سلام عليك! كل حفظ وأنت طيب 🌟", "مبروك الحفظ! أنت الأفضل 😎",
    "عفيه عليك يا نشمي! خلصتها زي المنسف بالجميد 🔥", "هيييه يا معلم! لو التشريعات بتفهم كانت صفقلك 👏👏",
]
...
def render_comparison_tab(qistas_df: pd.DataFrame):
    ...
    if current_index < total_records:
        ...
        st.success("🎉 تم الانتهاء من هذا النوع بنجاح!")
